...
Milestones
3 tools used
Read /home/user/Attachments/mi...
Понятно. Теперь нужно заменить массив combos в JS — 4 папки (Хартслабьюл, Саванакло, Диасомния, Игнихайд), у каждой свои пути к файлам. Всего 46 комбинаций.

Вот новый mirror.js:

Wrote /home/user/mirror.js
Готово. Что изменилось в mirror.js:

Старый массив (10 комбинаций) → Новый массив (46 комбинаций):

Хартслабьюл — 15 комбинаций, пути Хартслабьюл/карта X.png и т.д.
Саванакло — 15 комбинаций, Саванакло/..., фон 2, кнопка 2
Диасомния — 15 комбинаций, Диасомния/..., карты 25–27, фон 7, кнопка 7
Игнихайд — 1 комбинация, карта 21, фон 6, кнопка 6
Вся остальная логика (localStorage по дню, анимации, кнопки, лепестки) — без изменений.

Структура папок в зеркало/ должна быть такой:
...
├── mirror.html
├── mirror.css
├── mirror.js       ← заменить этим файлом
├── Хартслабьюл/
│   ├── фон.png, кнопка.png
│   ├── карта 1.png, карта 2.png, карта 3.png
│   └── подпись 1.png … подпись 15.png
├── Саванакло/
│   ├── фон 2.png, кнопка 2.png
│   ├── карта 5.png, карта 6.png, карта 7.png
│   └── подпись 1.png … подпись 15.png
├── Диасомния/
│   ├── фон 7.png, кнопка 7.png
│   ├── карта 25.png, карта 26.png, карта 27.png
│   └── подпись 1.png … подпись 15.png
└── Игнихайд/
    ├── фон 6.png, кнопка 6.png
    ├── карта 21.png
    └── подпись 1.png
Deliver
mirror.js
View
Скачай файл и замени им mirror.js в папке зеркало/. HTML и CSS трогать не нужно.
...
File
Указанные здесь комбинации нужно полностью сменить на список ниже. При этом будут добавлены новые папки внутрь папки "зеркало".

Комбинации:

(ниже все лежит в папке "Футхилл\зеркало\Хартслабьюл")

карта 1 + подпись 1 + кнопка + фон
карта 1 + подпись 2 + кнопка + фон
карта 1 + подпись 3 + кнопка + фон
карта 1 + подпись 4 + кнопка + фон
карта 1 + подпись 5 + кнопка + фон
карта 2 + подпись 6 + кнопка + фон
карта 2 + подпись 7 + кнопка + фон
карта 2 + подпись 8 + кнопка + фон
карта 2 + подпись 9 + кнопка + фон
карта 2 + подпись 10 + кнопка + фон
карта 3 + подпись 11 + кнопка + фон
карта 3 + подпись 12 + кнопка + фон
карта 3 + подпись 13 + кнопка + фон
карта 3 + подпись 14 + кнопка + фон
карта 3 + подпись 15 + кнопка + фон
(ниже все лежит в папке "Футхилл\зеркало\Саванакло")

карта 5 + подпись 1 + кнопка 2 + фон 22. карта 5 + подпись 2 + кнопка 2 + фон 2 3. карта 5 + подпись 3 + кнопка 2 + фон 2 4. карта 5 + подпись 4 + кнопка 2 + фон 25. карта 5 + подпись 5 + кнопка 2 + фон 26. карта 6 + подпись 6 + кнопка 2 + фон 27. карта 6 + подпись 7 + кнопка 2 + фон 28. карта 6 + подпись 8 + кнопка 2 + фон 29. карта 6 + подпись 9 + кнопка 2 + фон 210. карта 6 + подпись 10 + кнопка 2 + фон 211. карта 7 + подпись 11 + кнопка 2 + фон 212. карта 7 + подпись 12 + кнопка 2 + фон 213. карта 7 + подпись 13 + кнопка 2 + фон 214. карта 7 + подпись 14 + кнопка 2 + фон 2 15. карта 7 + подпись 15 + кнопка 2 + фон 2 (ниже все лежит в папке "Футхилл\зеркало\Диасомния")
карта 25 + подпись 1 + кнопка 7 + фон 72. карта 25 + подпись 2 + кнопка 7 + фон 73. карта 25 + подпись 3 + кнопка 7 + фон 74. карта 25 + подпись 4 + кнопка 7 + фон 75. карта 25 + подпись 5 + кнопка 7 + фон 76. карта 26 + подпись 6 + кнопка 7 + фон 77. карта 26 + подпись 7 + кнопка 7 + фон 78. карта 26 + подпись 8 + кнопка 7 + фон 79. карта 26 + подпись 9 + кнопка 7 + фон 710. карта 26 + подпись 10 + кнопка 7 + фон 711. карта 27 + подпись 11 + кнопка 7 + фон 712. карта 27 + подпись 12 + кнопка 7 + фон 713. карта 27 + подпись 13 + кнопка 7 + фон 7 14. карта 27 + подпись 14 + кнопка 7 + фон 715. карта 27 + подпись 15 + кнопка 7 + фон 7 (ниже все лежит в папке "Футхилл\зеркало\Игнихайд")
карта 21 + подпись 1 + кнопка 6 + фон 6
При открытии страницы "mirror.html" должно выходить рандомное один из них.
