...
function initGame(vkID, potionID) {
    ...
    const ingredientData = {
        ...
        rowan:      { name: 'рябина',   img: '../ингредиенты/ингредиент_рябина.png' },
        slime:      { name: 'слизь',            img: '../ингредиенты/ингредиент_слизь.png' }
    };
    ...
    const winRecipe = ['rowan', 'blood_salamander', 'slime', 'honey_water'];
